<template>
    <div class="content">
        <div :id="chartName" :style="{height: cHeight+'px'}"></div>
    </div>
</template>
...
<script>
    ...
    export default{
        name: 'chart',
        props: ['chartName', 'isMap', 'mapName', 'cHeight', 'cTitle', 'cSubTitle', 'cPosition'],
        data(){
            return {
                chart: null,
                mapData: [],
...
//                    },
                ...
                Object.assign(this.option, mapOption);

                if (window.fetch) {
                    fetch('assets/' + this.mapName + '.json').then((res) => {
                        res.json().then((json) => {
                            echarts.registerMap(this.mapName, json);
